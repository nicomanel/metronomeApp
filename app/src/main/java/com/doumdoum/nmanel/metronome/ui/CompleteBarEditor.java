...
public class CompleteBarEditor extends LinearLayout {
    ...
    public CompleteBarEditor(Context context, AttributeSet set) {
        super(context, set);
        addView(LayoutInflater.from(context).inflate(R.layout.complete_bar_editor, null));
